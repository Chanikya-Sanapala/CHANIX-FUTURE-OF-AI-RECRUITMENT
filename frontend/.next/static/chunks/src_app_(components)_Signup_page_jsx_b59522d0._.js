...
"[project]/src/app/(components)/Signup/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Signup = ()=>{
    ...
    const submitHandler = async (e)=>{
        ...
        const confirmPassword = userData.confirmPassword;
        if (password !== confirmPassword) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Password and Confirm Password do not match", {
                position: "top-right",
                autoClose: 5000
            });
            return;
        ...
        try {
            ...
            if (!res.data.error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(res.data.message || "Registration successful!", {
                    position: "top-right",
                    autoClose: 3000,
                    onClose: ()=>router.push("/Login")
                });
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res.data.message || "Registration failed", {
                    position: "top-right",
                    autoClose: 5000
                });
            }
...
//# sourceMappingURL=src_app_%28components%29_Signup_page_jsx_b59522d0._.js.map