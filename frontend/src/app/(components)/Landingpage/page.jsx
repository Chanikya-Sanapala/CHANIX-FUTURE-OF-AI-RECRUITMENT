...
function NavBar() {
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-md" style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
      <div className="mx-auto flex h-12 sm:h-14 max-w-7xl items-center justify-between px-4 sm:px-6">
        {/* Left: Logo */}
        <div className="text-lg sm:text-xl lg:text-2xl font-semibold tracking-tight text-white">Logo</div>

        {/* Center: Links */}
        <nav className="hidden gap-4 sm:gap-6 lg:gap-8 text-xs sm:text-sm md:flex">
          <a href="#about" className="text-neutral-300 transition-colors duration-200 ease-out text-xs sm:text-sm hover:text-white">About us</a>
          <a href="#recruiters" className="text-neutral-300 transition-colors duration-200 ease-out text-xs sm:text-sm hover:text-white">For recruiters</a>
          <a href="#candidates" className="text-neutral-300 transition-colors duration-200 ease-out text-xs sm:text-sm hover:text-white">For candidates</a>
          <div className="group relative">
            <button className="inline-flex items-center gap-1 text-neutral-300 transition-colors duration-200 ease-out text-xs sm:text-sm hover:text-white">
              Resources
      ...
      {/* Bottom thin divider removed since it's in the header style now */}
    </header>
  );
}
...
export default function Landing() {
  ...
  return (
    <>
      ...
      `}</style>
      <main className="w-full hero-bg min-h-screen text-white">
        <NavBar />
        {/* HERO */}
        <section className={`relative isolate transition-all duration-1000 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} id="about">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24 lg:py-32 xl:py-40">
            ...
            <p className={`mx-auto mt-3 sm:mt-4 lg:mt-6 max-w-xs sm:max-w-xl lg:max-w-2xl text-center text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed text-neutral-300 transition-all duration-700 ease-out delay-100 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <div className={`mt-6 sm:mt-7 lg:mt-8 flex items-center justify-center gap-3 transition-all duration-700 ease-out delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <a href="/Signup" className="group rounded-full bg-white px-3 sm:px-4 lg:px-5 py-1.5 sm:py-2 lg:py-2.5 text-xs sm:text-sm md:text-base font-semibold text-black shadow-sm transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-lg inline-block hover:bg-neutral-200">
        ...
        <section className={`mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`} id="recruiters">
          <div className="text-center text-sm sm:text-base font-semibold text-purple-400">Interviews</div>
          <h2 className="mt-2 sm:mt-3 text-balance text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight text-white">
            Voice-enabled AI
            <br className="hidden sm:block" /> interviews at scale
          </h2>
          <p className="mx-auto mt-3 sm:mt-4 max-w-xl sm:max-w-2xl text-center text-sm sm:text-base text-neutral-300">
          ...
          <div className="mx-auto mt-8 sm:mt-12 lg:mt-14 grid max-w-5xl grid-cols-1 gap-8 sm:gap-10 lg:gap-12 sm:grid-cols-2 lg:grid-cols-3">
            <div className={`text-center transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`} style={{ transitionDelay: '100ms' }}>
              <div className="group mx-auto mb-4 sm:mb-5 flex h-10 w-10 sm:h-11 sm:w-11 items-center justify-center rounded-full border border-white/20 bg-white/5 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:border-white/40">
                <span className="text-base sm:text-lg transition-transform duration-300 group-hover:rotate-12">🏃‍♂️</span>
              </div>
              <h3 className="text-xl sm:text-2xl font-extrabold leading-snug text-white transition-colors duration-300">
                Conduct
                <br /> structured
                <br /> unbiased
                <br /> interviews
              </h3>
              <p className="mx-auto mt-2 sm:mt-3 max-w-xs sm:max-w-sm text-xs sm:text-sm text-neutral-300 transition-colors duration-300">
          ...
          <div className="mt-6 sm:mt-8 lg:mt-10 relative overflow-hidden">
            <div className="flex animate-slide-left space-x-3 sm:space-x-4">
              {[...jobCards, ...jobCards].map((job, index) => (
                <article
                  key={`${job.title}-${index}`}
                  className="flex-shrink-0 w-64 sm:w-72 lg:w-80 group rounded-lg border border-white/10 bg-white/5 backdrop-blur-sm overflow-hidden transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-lg hover:border-white/20"
                >
                  <div className={`h-0.5 bg-gradient-to-r ${job.color}`}></div>
                  <div className="p-3 sm:p-4">
                    <div className="flex items-start justify-between mb-2 sm:mb-3">
                      <div>
                        <h3 className="text-sm sm:text-base font-semibold text-white transition-colors duration-300 group-hover:text-purple-300">
                          {job.title}
                        </h3>
                        <p className="text-xs sm:text-sm text-neutral-400 mt-0.5">{job.company}</p>
                      </div>
                      <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-white/10 text-white border border-white/5">
                        {job.type}
                      </span>
                    </div>
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {job.skills.slice(0, 3).map((skill, skillIndex) => (
                          <span
                            key={skillIndex}
                            className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-white/5 text-neutral-200 border border-white/5 transition-colors duration-300 group-hover:bg-white/10"
                          >
                            {skill}
                          </span>
                        ))}
        ...
        <section className={`mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`}>
          ...
          <div className="mt-6 sm:mt-8 lg:mt-10 grid grid-cols-1 gap-4 sm:gap-6 lg:gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <article
                key={i}
                className={`group rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-4 sm:p-6 transition-all duration-500 ease-out hover:-translate-y-2 hover:shadow-xl hover:border-white/20 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
                style={{ transitionDelay: `${i * 100}ms` }}
              >
                <div className="space-y-2 sm:space-y-3">
                  <div className="text-xs sm:text-sm font-semibold text-purple-400 transition-colors duration-300">{c.label}</div>
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-extrabold leading-snug text-white transition-colors duration-300">{c.title}</h3>
                  <p className="text-xs sm:text-sm text-neutral-300 transition-colors duration-300">{c.body}</p>
                </div>
              </article>
            ))}
          </div>
        ...
        <section className={`mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`}>
          ...
          <div className="mt-6 sm:mt-8 flex flex-wrap items-center justify-center gap-4 sm:gap-6 lg:gap-8 text-xs sm:text-sm text-neutral-400">
            <button
              onClick={() => setActiveRecruiterTab('automate')}
              className={`border-b-2 pb-1 font-medium transition-colors duration-200 ease-out hover:text-white ${activeRecruiterTab === 'automate' ? 'border-purple-400 text-white' : 'border-transparent'
                }`}
            >
              Automate first
            </button>
            <button
              ...
              className={`border-b-2 pb-1 font-medium transition-colors duration-200 ease-out hover:text-white ${activeRecruiterTab === 'focus' ? 'border-purple-400 text-white' : 'border-transparent'
                }`}
            >
              Focus on top
            </button>
            <button
              ...
              className={`border-b-2 pb-1 font-medium transition-colors duration-200 ease-out hover:text-white ${activeRecruiterTab === 'diverse' ? 'border-purple-400 text-white' : 'border-transparent'
                }`}
            >
              Build diverse
            </button>
          ...
          <div className="mx-auto mt-8 sm:mt-12 lg:mt-14 max-w-2xl sm:max-w-3xl">
            {activeRecruiterTab === 'automate' && (
              <>
                <div className="text-sm sm:text-base font-semibold text-purple-400">Automation</div>
                <h3 className="mt-2 sm:mt-3 text-2xl sm:text-3xl font-extrabold leading-snug text-white">
                  Automate first-round interviews with AI
                </h3>
                <p className="mt-2 sm:mt-3 text-sm sm:text-base text-neutral-300">
            ...
            {activeRecruiterTab === 'focus' && (
              <>
                <div className="text-sm sm:text-base font-semibold text-purple-400">Focus</div>
                <h3 className="mt-2 sm:mt-3 text-2xl sm:text-3xl font-extrabold leading-snug text-white">
            ...
            {activeRecruiterTab === 'diverse' && (
              <>
                <div className="text-sm sm:text-base font-semibold text-purple-400">Diversity</div>
                <h3 className="mt-2 sm:mt-3 text-2xl sm:text-3xl font-extrabold leading-snug text-white">
                ...
                <button className="mt-4 sm:mt-6 inline-flex items-center gap-2 rounded-full bg-white px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-purple-700 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow">
                  Discover
        ...
        <section className={`mx-auto max-w-6xl px-6 py-20 transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`}>
          <div className="text-center text-sm font-semibold text-purple-400">Promise</div>
          <h2 className="mt-3 text-center text-4xl font-extrabold tracking-tight sm:text-5xl text-white">
            The SmartEngine promise
          </h2>
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2">
            <article className={`group rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-8 transition-all duration-500 ease-out hover:-translate-y-2 hover:shadow-xl hover:border-white/20 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '100ms' }}>
              <div className="text-sm font-semibold text-purple-400 transition-colors duration-300">Faster</div>
              <h3 className="mt-2 text-3xl font-extrabold leading-snug sm:text-4xl text-white transition-colors duration-300">
                Reduce hiring cycles from months to weeks
              </h3>
              <p className="mt-3 text-neutral-300 transition-colors duration-300">
                Move at the speed of talent. Automated screening means qualified candidates reach you faster. No waiting. No bottlenecks.
              </p>
            </article>

            <article className={`group rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-8 transition-all duration-500 ease-out hover:-translate-y-2 hover:shadow-xl hover:border-white/20 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '200ms' }}>
              <div className="text-sm font-semibold text-purple-400 transition-colors duration-300">Fairer</div>
              <h3 className="mt-2 text-3xl font-extrabold leading-snug sm:text-4xl text-white transition-colors duration-300">
        ...
        <section className={`mx-auto max-w-6xl px-6 py-20 transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`} id="candidates">
          <div className="text-center text-sm font-semibold text-purple-400">Candidates</div>
          <h2 className="text-center text-4xl font-extrabold sm:text-5xl text-white">Show what you can do</h2>
          ...
          <div className="mt-12 border-b border-white/10">
            <nav className="-mb-px flex justify-center space-x-8" aria-label="Tabs">
              <button
                ...
                className={`whitespace-nowrap border-b-2 px-1 pb-4 text-sm font-medium transition-colors ${activeCandidateTab === 'showcase' ? 'border-purple-400 text-white' : 'border-transparent text-neutral-400 hover:border-neutral-300 hover:text-white'}`}
              >
                Showcase skills
              </button>
              <button
                onClick={() => setActiveCandidateTab('matched')}
                className={`whitespace-nowrap border-b-2 px-1 pb-4 text-sm font-medium transition-colors ${activeCandidateTab === 'matched' ? 'border-purple-400 text-white' : 'border-transparent text-neutral-400 hover:border-neutral-300 hover:text-white'}`}
              >
                Get matched right
              </button>
              <button
                onClick={() => setActiveCandidateTab('access')}
                className={`whitespace-nowrap border-b-2 px-1 pb-4 text-sm font-medium transition-colors ${activeCandidateTab === 'access' ? 'border-purple-400 text-white' : 'border-transparent text-neutral-400 hover:border-neutral-300 hover:text-white'}`}
              >
                Access new
              </button>
            </nav>
          ...
          <div className="mt-10">
            {activeCandidateTab === 'showcase' && (
              <div className="max-w-3xl mx-auto">
                <Pill>Skills</Pill>
                <h3 className="mt-3 text-4xl font-extrabold text-white">Showcase skills through structured interviews</h3>
            ...
            {activeCandidateTab === 'matched' && (
              <div className="max-w-3xl mx-auto">
                <Pill>Matching</Pill>
                <h3 className="mt-3 text-4xl font-extrabold text-white">Get matched to the right opportunities</h3>
                <p className="mt-3 text-neutral-300">
            ...
            {activeCandidateTab === 'access' && (
              <div className="max-w-3xl mx-auto">
                ...
                <h3 className="mt-3 text-4xl font-extrabold text-white">Access new opportunities everywhere</h3>
                <p className="mt-3 text-neutral-300">
        ...
        <section className={`mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`}>
          <div className="grid grid-cols-1 items-center gap-8 sm:gap-10 lg:gap-12 md:grid-cols-[1fr_minmax(280px,400px)] lg:grid-cols-[1fr_minmax(320px,520px)]">
            <div>
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white">Real results</h3>
              <p className="mt-2 sm:mt-3 max-w-sm sm:max-w-md text-sm sm:text-base text-neutral-300">
                Hear from recruiters and candidates who've experienced the SmartEngine difference.
              </p>
            </div>
            <div className={`rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-4 sm:p-6 transition-all duration-500 ease-out hover:-translate-y-2 hover:shadow-xl hover:border-white/20 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <div className="flex items-center gap-1 text-yellow-500">
                {'★'.repeat(reviews[currentReview].rating)}
              </div>
              <p className="mt-2 text-sm sm:text-base text-white transition-colors duration-300">
                {reviews[currentReview].text}
              </p>
              <div className="mt-3 sm:mt-4 flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-neutral-300">
                <div className="flex h-6 w-6 sm:h-8 sm:w-8 items-center justify-center rounded-full bg-white/10 transition-transform duration-300 hover:scale-110">
                  <span className="text-xs sm:text-base">{reviews[currentReview].avatar}</span>
                </div>
                <div>
                  <div className="font-semibold text-white text-xs sm:text-sm">{reviews[currentReview].author}</div>
              ...
              <div className="mt-4 sm:mt-6 flex items-center justify-between">
                <div className="text-neutral-500 text-xs sm:text-sm">
                  {reviews.map((_, index) => (
                    <span key={index} className={`inline-block transition-all duration-300 ${index === currentReview ? 'text-white scale-110' : 'scale-100'}`}>
                      {index === currentReview ? '●' : '○'}
                    </span>
                  ))}
                </div>
        ...
        <section className={`mx-auto max-w-6xl px-6 pb-24 transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`}>
          <h2 className={`text-center text-4xl font-extrabold sm:text-5xl text-white transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>Join the movement</h2>
          <p className={`mx-auto mt-2 max-w-2xl text-center text-neutral-300 transition-all duration-700 ease-out delay-100 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        ...
        {/* FOOTER */}
        <footer className={`bg-black/40 backdrop-blur-md border-t border-white/5 text-white transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`}>
